/* Program to Show the joining records from two different tables of localhost user created databse which is java and table name is student.*/
...
public class JoinRecordsDB {
    public static void main(String args[]) {
        ...
        try {
            ...
            String query = "SELECT Student.sid, Employees.name FROM Student INNER JOIN Employees ON Student.sid = Employees.Id";
